...
const baselinePath='release/baselines/v2-critical-hashes.json';
...
export default async function handler(req,res){
 ...
 try{
  ...
  return send(res,ok?200:500,{ok,release:releaseRuntime(),parityContract:'v1.1.8-protected-baseline-plus-v2-additive',foundationContract:'atlas-data-contract-v1.1',accessContract:'public-summary-plus-authenticated-admin-v1',criticalIntegrity:ok,checkedFiles:files.length,files});
