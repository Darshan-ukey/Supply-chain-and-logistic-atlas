...
function publicReadiness(source){
  ...
  return {
    ...
    unresolved:{
      operationalKnowledgeCount:sourceContextPending+unknownCount,
      sourceContextPendingCount:sourceContextPending,
      clientBindingCount,
      metricDefinitionPendingCount:metricPending?1:0,
      unknownCount
    },
    dependencies:{
      deterministicVsJudgement:'UNKNOWN',
      hitlRequired:true,
      systemActionRequired:false,
      clientBindingRequired:clientBindingCount>0
    },
    downstream:{
