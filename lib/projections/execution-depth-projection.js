...
export function buildPublicExecutionDepthProjection(args){
  ...
  if(entry.publicProjectionBundlePath)return applySafeDecompositionSummary(entry,args.taskId,loadPrecompiledPublicProjection(entry,args.taskId));
  ...
  return applySafeDecompositionSummary(entry,args.taskId,projection);
}
